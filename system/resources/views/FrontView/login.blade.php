			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(public/Login/images/2.jpg);">
			      </div>
						<div class="login-wrap p-4 p-md-5">
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Sign In to Admin</h3>
			      		</div>
								<div class="w-100">
		          ...
		          <p class="text-center">Not a member? <a class="loginhere-link" href="/registrasi">Sign Up</a></p>
		        </div>
		      </div>
				</div>
			</div>
